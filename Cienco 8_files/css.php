...
/*css body khung chinh*/
	.pc{font-family:Arial, Helvetica, sans-serif;background:#FFFFFF;text-align:center;font-size:14px;color:#333333;}
...
.pc  .mm-menu{text-align:left;}
	...
	.mobile{font-family:Arial, Helvetica, sans-serif;background:#FFFFFF;text-align:center;font-size:14px;color:#000000;}
...
.diendan .header_nhom{background:#2474B1 ; }
.diendan .header_forum_chinh{background:#2474B1 ;  }
.diendan .header_box_diendan{background:#2474B1 ;  }

.diendan .thanh_dinh_huong_dien_dan{background:#2474B1 ;  ;margin-bottom:5px;padding:5px; border:1px solid #cccccc; color:#fff;font-weight:bold }
.diendan .thanh_dinh_huong_dien_dan a{ color:#fff; }

.diendan .header_box_diendan{padding:5px; border:1px solid #cccccc;border-bottom:0px;background:#2474B1) ; color:#fff;font-weight:bold }
...
background:#2474B1;color:#fff;
}
.nut1be,.nut2be{
padding:4px 10px;border:none; border-radius:2px;
background:#2474B1;color:#fff;font-size:small
}
...
.nen2{
background:#EACA00;color:#fff;
}
.nut3{
padding:5px 10px;border:none; border-radius:1px;
background:#2474B1;color:#fff;
}
.paging .link_dang_chon{ background:#2474B1; color:#fff !important;}
.thuoctinh_dangchon{color:#2474B1; font-weight:bold}
 
 
 

	.bocuc_35  > .loprong{background:#fff;
border:1px solid #EACA00;
padding:10px;}
	.bocuc_35  > .loprong >.header{background: url(/userfiles/img/604418/line2.png) no-repeat bottom;
    text-align: center;
    margin-bottom: 10px;}
	.bocuc_36 {background-position:10px center !important;}
	.bocuc_36  > .loprong{border:1px solid #EACA00;
margin-top:20px;
font-weight:bold;
border-radius:5px;}
	.bocuc_236  > .loprong >.padding{padding: 20px 0;}
	.bocuc_263  > .loprong >.padding{padding: 20px 10px;}
	.bocuc_297  > .loprong >.padding{padding: 20px 10px;}
	.bocuc_303  > .loprong >.padding{padding: 20px 0;}
.mobile .maubaiviet_1 .baiviet_box .div_noidung{display:table;
width:100%;
padding:10px 0;
...
.bocuc_227 ul li > div:hover:before{
   left: 3.5%;
    opacity: 1;
}

.bocuc_227 ul li > div:hover .tieude {
    opacity: 1;
}
.bocuc_227 ul li > div:hover .mota{
     top : 55%;
    opacity: 1;
}
/* het css id 227 */
...
.bocuc_255 ul li > div:hover:before{
   left: 3.5%;
    opacity: 1;
}

.bocuc_255 ul li > div:hover .tieude {
    opacity: 1;
}
.bocuc_255 ul li > div:hover .mota{
     top : 55%;
    opacity: 1;
}
/* het css id 255 */
...
.bocuc_256 ul li > div:hover:before{
   left: 3.5%;
    opacity: 1;
}

.bocuc_256 ul li > div:hover .tieude {
    opacity: 1;
}
.bocuc_256 ul li > div:hover .mota{
     top : 55%;
    opacity: 1;
}
/* het css id 256 */
...
.bocuc_290 ul li > div:hover:before{
   left: 3.5%;
    opacity: 1;
}

.bocuc_290 ul li > div:hover .tieude {
    opacity: 1;
}
.bocuc_290 ul li > div:hover .mota{
     top : 55%;
    opacity: 1;
}
/* het css id 290 */
...
.bocuc_254 ul li > div:hover:before{
   left: 3.5%;
    opacity: 1;
}

.bocuc_254 ul li > div:hover .tieude {
    opacity: 1;
}
.bocuc_254 ul li > div:hover .mota{
     top : 55%;
    opacity: 1;
}
/* het css id 254 */
...
/* css id 336 */
.bocuc_336 .loprong .padding p marquee a:hover{    border-bottom: 1px solid;
}
/* het css id 336 */
